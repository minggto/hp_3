...
def build_deeplabv3(inputs, preset_model, num_classes, is_training=True):
    if preset_model != "tiny_deeplabv3":
    ...
    with tf.variable_scope('tiny_deeplabv3/decoder_module'):
